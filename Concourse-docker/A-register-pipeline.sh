...
fly --target $CONCOURSE_TARGET login --insecure --concourse-url http://${CONCOURSE_ENDPOINT}:8081 -n main
...
fly -t $CONCOURSE_TARGET unpause-pipeline -p install-nsx-t
